...
class connection_handle
{
  public:
    ...
    [[nodiscard]] core_error_info analytics_query(zval* return_value, const zend_string* statement, const zval* options);
    ...
    [[nodiscard]] core_error_info bucket_create(zval* return_value, const zval* bucket_settings, const zval* options);

    [[nodiscard]] core_error_info bucket_update(zval* return_value, const zval* bucket_settings, const zval* options);
