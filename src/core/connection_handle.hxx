...
namespace couchbase::php {
    ...
    public:
        ...
        [[nodiscard]] core_error_info
        analytics_query(zval *return_value, const zend_string *statement, const zval *options);

        [[nodiscard]] core_error_info search_query(zval *return_value,
                                                   const zend_string *index_name,
                                                   const zend_string *query,
                                                   const zval *options);

        [[nodiscard]] core_error_info view_query(zval *return_value,
        ...
        [[nodiscard]] core_error_info
        diagnostics(zval *return_value, const zend_string *report_id, const zval *options);

        [[nodiscard]] core_error_info search_index_upsert(zval *return_value, const zval *index, const zval *options);

        [[nodiscard]] core_error_info view_index_upsert(zval *return_value,
                                                        const zend_string *bucket_name,
        ...
        [[nodiscard]] core_error_info
        bucket_create(zval *return_value, const zval *bucket_settings, const zval *options);

        [[nodiscard]] core_error_info bucket_update(zval *return_value,
                                                    const zval *bucket_settings,
                                                    const zval *options);

        [[nodiscard]] core_error_info bucket_get(zval *return_value, const zend_string *name, const zval *options);

        [[nodiscard]] core_error_info bucket_get_all(zval *return_value, const zval *options);

        [[nodiscard]] core_error_info bucket_drop(zval *return_value, const zend_string *name, const zval *options);
    ...
    create_connection_handle(const zend_string *connection_string, zval *options,
