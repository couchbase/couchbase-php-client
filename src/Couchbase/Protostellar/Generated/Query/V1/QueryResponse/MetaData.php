...
class MetaData extends \Google\Protobuf\Internal\Message
{
     ...
     *     @type int $status
     *     @type \Couchbase\Protostellar\Generated\Query\V1\QueryResponse\MetaData\Warning[]|\Google\Protobuf\Internal\RepeatedField $warnings
     *     @type string $profile
    ...
    {
        GPBUtil::checkEnum($var, \Couchbase\Protostellar\Generated\Query\V1\QueryResponse\MetaData\MetaDataStatus::class);
        $this->status = $var;
    ...
    /**
     * Generated from protobuf field <code>repeated .couchbase.query.v1.QueryResponse.MetaData.Warning warnings = 5;</code>
     * @param \Couchbase\Protostellar\Generated\Query\V1\QueryResponse\MetaData\Warning[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
