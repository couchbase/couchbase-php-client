...
class MutateArrayInsertSpec implements MutateInSpec
{
    ...
    {
        return new MutateArrayInsertSpec($path, $values, $isXattr, $createPath, $expandMacros);
    }

    public function xattr(bool $isXattr): MutateArrayInsertSpec
    {
        $this->isXattr = $isXattr;
        return $this;
    }

    public function createPath(bool $createPath): MutateArrayInsertSpec
    {
        $this->createPath = $createPath;
        return $this;
    }

    public function expandMacros(bool $expandMacros): MutateArrayInsertSpec
    {
        $this->expandMacros = $expandMacros;
        return $this;
    }
    ...
    public function export(?MutateInOptions $options): array
    {
        ...
        return [
            'operation' => Operation::ARRAY_INSERT,
            'flags' => $flags,
            'path' => $this->path,
            'content' => join(
                ",",
