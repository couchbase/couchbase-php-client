...
class BucketAdminClient extends \Grpc\BaseStub
{
    ...
    public function ListBuckets(
        \Couchbase\StellarNebula\Generated\Admin\Bucket\V1\ListBucketsRequest $argument,
        $metadata = [],
        $options = []
    )
    {
    ...
    public function CreateBucket(
        \Couchbase\StellarNebula\Generated\Admin\Bucket\V1\CreateBucketRequest $argument,
        $metadata = [],
        $options = []
    )
    {
    ...
    public function UpdateBucket(
        \Couchbase\StellarNebula\Generated\Admin\Bucket\V1\UpdateBucketRequest $argument,
        $metadata = [],
        $options = []
    )
    {
    ...
    public function DeleteBucket(
        \Couchbase\StellarNebula\Generated\Admin\Bucket\V1\DeleteBucketRequest $argument,
        $metadata = [],
        $options = []
    )
    {
