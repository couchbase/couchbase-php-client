...
class HooksClient extends \Grpc\BaseStub
{
    ...
    public function CreateHooksContext(
        \Couchbase\StellarNebula\Generated\Internal\Hooks\V1\CreateHooksContextRequest $argument,
        $metadata = [],
        $options = []
    )
    {
    ...
    public function DestroyHooksContext(
        \Couchbase\StellarNebula\Generated\Internal\Hooks\V1\DestroyHooksContextRequest $argument,
        $metadata = [],
        $options = []
    )
    {
    ...
    public function AddHooks(
        \Couchbase\StellarNebula\Generated\Internal\Hooks\V1\AddHooksRequest $argument,
        $metadata = [],
        $options = []
    )
    {
    ...
    public function WatchBarrier(
        \Couchbase\StellarNebula\Generated\Internal\Hooks\V1\WatchBarrierRequest $argument,
        $metadata = [],
        $options = []
    )
    {
    ...
    public function SignalBarrier(
        \Couchbase\StellarNebula\Generated\Internal\Hooks\V1\SignalBarrierRequest $argument,
        $metadata = [],
        $options = []
    )
    {
