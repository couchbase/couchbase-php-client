...
class ViewQueryRequest extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Couchbase\StellarNebula\Generated\View\V1\ViewQueryRequest\ScanConsistency::class);
    ...
    {
        GPBUtil::checkEnum($var, \Couchbase\StellarNebula\Generated\View\V1\ViewQueryRequest\ErrorMode::class);
        $this->on_error = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Couchbase\StellarNebula\Generated\View\V1\ViewQueryRequest\DesignDocumentNamespace::class);
        $this->namespace = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Couchbase\StellarNebula\Generated\View\V1\ViewQueryRequest\Order::class);
        $this->order = $var;
