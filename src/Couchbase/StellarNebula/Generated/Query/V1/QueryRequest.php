...
class QueryRequest extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * Generated from protobuf field <code>optional .couchbase.query.v1.QueryRequest.QueryScanConsistency scan_consistency = 8;</code>
     */
    ...
    /**
     * Generated from protobuf field <code>optional .couchbase.query.v1.QueryRequest.QueryProfileMode profile_mode = 14;</code>
     */
     ...
     *     @type bool $read_only
     *     @type bool $prepared
     *     @type \Couchbase\StellarNebula\Generated\Query\V1\QueryRequest\TuningOptions $tuning_options
     *     @type string $client_context_id
     *     @type int $scan_consistency
     *     @type string[]|\Google\Protobuf\Internal\RepeatedField $positional_parameters
     *     @type array|\Google\Protobuf\Internal\MapField $named_parameters
     *     @type bool $flex_index
     *     @type bool $preserve_expiry
     *     @type \Couchbase\StellarNebula\Generated\KV\V1\MutationToken[]|\Google\Protobuf\Internal\RepeatedField $consistent_with
    ...
    /**
     * Generated from protobuf field <code>optional .couchbase.query.v1.QueryRequest.TuningOptions tuning_options = 6;</code>
     * @return \Couchbase\StellarNebula\Generated\Query\V1\QueryRequest\TuningOptions|null
     */
    ...
    /**
     * Generated from protobuf field <code>optional .couchbase.query.v1.QueryRequest.TuningOptions tuning_options = 6;</code>
     * @param \Couchbase\StellarNebula\Generated\Query\V1\QueryRequest\TuningOptions $var
     * @return $this
     */
    public function setTuningOptions($var)
    {
        GPBUtil::checkMessage($var, \Couchbase\StellarNebula\Generated\Query\V1\QueryRequest\TuningOptions::class);
    ...
    {
        GPBUtil::checkEnum($var, \Couchbase\StellarNebula\Generated\Query\V1\QueryRequest\QueryScanConsistency::class);
    ...
    /**
     * Generated from protobuf field <code>repeated .couchbase.kv.v1.MutationToken consistent_with = 13;</code>
     * @param \Couchbase\StellarNebula\Generated\KV\V1\MutationToken[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setConsistentWith($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Couchbase\StellarNebula\Generated\KV\V1\MutationToken::class);
    ...
    {
        GPBUtil::checkEnum($var, \Couchbase\StellarNebula\Generated\Query\V1\QueryRequest\QueryProfileMode::class);
