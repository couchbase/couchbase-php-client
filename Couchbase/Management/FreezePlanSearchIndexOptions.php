...
class FreezePlanSearchIndexOptions
{
     ...
     * @since 4.5.0
     */
    public function parentSpan(RequestSpan $parentSpan): FreezePlanSearchIndexOptions
    {
     ...
     * @internal
     */
    public static function getParentSpan(?FreezePlanSearchIndexOptions $options): ?RequestSpan
    {
