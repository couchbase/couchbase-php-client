...
class GetAnalyticsPendingMutationsOptions
{
     ...
     * @since 4.5.0
     */
    public function parentSpan(RequestSpan $parentSpan): GetAnalyticsPendingMutationsOptions
    {
     ...
     * @internal
     */
    public static function getParentSpan(?GetAnalyticsPendingMutationsOptions $options): ?RequestSpan
    {
