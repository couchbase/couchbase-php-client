...
class AnalyzeDocumentOptions
{
     ...
     * @since 4.5.0
     */
    public function parentSpan(RequestSpan $parentSpan): AnalyzeDocumentOptions
    {
     ...
     * @internal
     */
    public static function getParentSpan(?AnalyzeDocumentOptions $options): ?RequestSpan
    {
