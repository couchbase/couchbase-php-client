...
class FlushBucketOptions
{
     ...
     * @since 4.0.0
     */
    public static function build(): FlushBucketOptions
    {
     ...
     * @since 4.0.0
     */
    public function timeout(int $milliseconds): FlushBucketOptions
    {
     ...
     * @since 4.5.0
     */
    public function parentSpan(RequestSpan $parentSpan): FlushBucketOptions
    {
     ...
     * @internal
     */
    public static function getParentSpan(?FlushBucketOptions $options): ?RequestSpan
    {
