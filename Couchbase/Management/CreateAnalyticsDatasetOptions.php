...
class CreateAnalyticsDatasetOptions
{
     ...
     * @since 4.5.0
     */
    public function parentSpan(RequestSpan $parentSpan): CreateAnalyticsDatasetOptions
    {
     ...
     * @internal
     */
    public static function getParentSpan(?CreateAnalyticsDatasetOptions $options): ?RequestSpan
    {
