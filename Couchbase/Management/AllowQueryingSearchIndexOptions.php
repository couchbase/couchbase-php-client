...
class AllowQueryingSearchIndexOptions
{
     ...
     * @since 4.5.0
     */
    public function parentSpan(RequestSpan $parentSpan): AllowQueryingSearchIndexOptions
    {
     ...
     * @internal
     */
    public static function getParentSpan(?AllowQueryingSearchIndexOptions $options): ?RequestSpan
    {
